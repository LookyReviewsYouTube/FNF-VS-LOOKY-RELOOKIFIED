...
find . -name -name "*.astc" -or -name "*.xml" -exec cp -r --parents -t "$DEST_ASTC_DIR" {} +
...
find characters \( -name "*.png" -or -name "*.xml" -or -name "*.json" \)  -exec cp --parents -t "$DEST_DIR/images" {} +
find characters -name "*.astc" -exec cp -r --parents -t "$DEST_ASTC_DIR/images" {} +
...
cd assets/base_game/characters
find . \( -name "*.png" -or -name "*.xml" -or -name "*.json" \) -exec cp -r --parents -t "$DEST_DIR/images/characters" {} +
find . -name "*.astc" -exec cp -r --parents -t "$DEST_ASTC_DIR/images/characters" {} +
cd - > /dev/null

cd assets/base_game/week_data
find . -name "*" -exec cp -r --parents -t "$DEST_DIR" {} +
find . -name "*.astc" -exec cp -r --parents -t "$DEST_ASTC_DIR" {} +
cd - > /dev/null
